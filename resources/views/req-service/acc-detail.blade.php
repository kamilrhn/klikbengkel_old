   ...
   <div class="row mt-4">
      <div class="col-12">
         <div class="float-right">
            @if($service->status == 'Request Cancel')
            <a href="{{ route('decline.cancel', $service->no_service) }}" style="color:white;" class="btn btn-danger">Decline</a>
            <a href="{{ route('approve.cancel', $service->no_service) }}"  style="color:white;" class="btn btn-success">Approve</a>
            @endif
         </div>
      </div>
   </div>
