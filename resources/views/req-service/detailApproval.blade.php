            ...
            <div class="card-header">
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-8">
                     ...
                     <h3 class="mb-0">Upload Bukti Sebelum Service</h3>
   ...
   <div class="row mt-4">
      ...
      <div class="col-12">
         ...
         <div class="float-right">
                ...
                <a href="{{ route('decline.service', $service->no_service) }}" style="color:white;" class="btn btn-danger">Decline</a>

                <a href="{{ route('approve.service', $service->no_service) }}"  style="color:white;" class="btn btn-success">Approve</a>
