<div class="header pb-8 pt-5 pt-md-8" style="background-color:#ed1c24;">
    <div class="container-fluid">
        <div class="header-body">
                        ...
                        <form action="#" method="GET" class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" name="search" placeholder="Search Nopol" type="text">
                                </div>
                            </div>
                        </form>
            ...
            <form action="{{route('search.history')}}" method="GET" enctype="multipart/form-data">
                <div class="row align-items-center d-flex mb--2">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <div class="form-control-label" style="color:white;">Status</div>
                            <select class="form-control" name="status">
                                <option value="" @if($statusnya == NULL) selected disabled @endif>Pilih Salah Satu</option>
                                @foreach($status as $s)
                                <option value="{{$s->status}}" @if($statusnya == $s->status) selected @endif>{{$s->status}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
